from taxonomy.script.step import StepArgParser
from taxonomy.script.step import StepDecorator
...
if __name__ == "__main__":
    ...
    parser = StepArgParser(step_description)    args = parser.parse_args()
